...
class ProgressBar extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    ...
    return _RenderProgressBar(
      ...
      thumbBorderThickness:thumbBorderThickness,
      thumbBorderColor: thumbBorderColor ?? Colors.transparent,
...
class _RenderProgressBar extends RenderBox {
  _RenderProgressBar({
    ...
    double thumbBorderThickness = 0.0,
    Color thumbBorderColor=Colors.transparent,
    ...
    double timeLabelPadding = 0.0,
        ...
        _thumbBorderThickness = thumbBorderThickness,
  ...
  double get thumbBorderThickness => _thumbBorderThickness;
  double _thumbBorderThickness;
  set thumbBorderThickness(double value) {
    if(_thumbBorderThickness == value) return;
  ...
  Color get thumbBorderColor => _thumbBorderColor;
  Color _thumbBorderColor;
  set thumbBorderColor(Color value) {
    if (_thumbBorderColor == value) return;
  ...
  void _drawThumb(Canvas canvas, Size localSize) {
    ...
    final thumbBorderRadius = thumbRadius + _thumbBorderThickness; // Border dahil toplam yarıçap
    ...
    if (_userIsDraggingThumb) {
      final thumbGlowPaint = Paint()..color = thumbGlowColor;
      canvas.drawCircle(center, thumbBorderRadius + thumbGlowRadius, thumbGlowPaint);
    }
    // Thumb çizimi
    canvas.drawCircle(center, thumbRadius, thumbPaint);
    // Sınır çizimi (border)
    final thumbBorderPaint = Paint()
      ..color = thumbBorderColor // Sınır rengi
      ..style = PaintingStyle.stroke // İçi dolu olmayan çizgi olarak çiz
      ..strokeWidth = _thumbBorderThickness; // Sınır kalınlığı
    if(_thumbBorderThickness>0) canvas.drawCircle(center, thumbRadius - _thumbBorderThickness/2, thumbBorderPaint);
